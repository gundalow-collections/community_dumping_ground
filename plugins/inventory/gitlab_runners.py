...
DOCUMENTATION = '''name: gitlab_runners
...
options:
  plugin:
    description: The name of this plugin, it should always be set to 'gitlab_runners'
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ...
    NAME = 'community.dumping_ground.gitlab_runners'
