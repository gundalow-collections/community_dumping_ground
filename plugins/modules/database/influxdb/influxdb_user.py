...
DOCUMENTATION = '''module: influxdb_user
...
options:
  ...
  grants:
    description:
    - Privileges to grant to this user. Takes a list of dicts containing the "database"
      and "privilege" keys.
    - If this argument is not provided, the current grants will be left alone. If
      an empty list is provided, all grants for the user will be removed.
extends_documentation_fragment:
- community.dumping_ground.influxdb
'''
...
import ansible_collections.community.dumping_ground.plugins.module_utils.influxdb as influx
