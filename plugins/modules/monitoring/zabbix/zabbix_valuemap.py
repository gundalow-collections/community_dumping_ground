...
DOCUMENTATION = '''module: zabbix_valuemap
...
options:
  ...
  state:
    ...
    - On C(present), it will create a value map if it does not exist or update the
      value map if the associated data is different.
