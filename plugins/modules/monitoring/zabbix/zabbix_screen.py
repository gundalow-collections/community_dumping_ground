...
DOCUMENTATION = '''module: zabbix_screen
short_description: Create/update/delete Zabbix screens
description:
- This module allows you to create, modify and delete Zabbix screens and associated
  graph data.
author:
- Cove (@cove)
...
options:
  screens:
    ...
    suboptions:
      ...
      state:
        description:
        - I(present) - Create a screen if it doesn't exist. If the screen already
          exists, the screen will be updated as needed.
...
- zabbix
notes:
- Too many concurrent updates to the same screen may cause Zabbix to return errors,
  see examples for a workaround if needed.
'''
