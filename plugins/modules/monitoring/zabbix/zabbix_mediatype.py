...
DOCUMENTATION = '''module: zabbix_mediatype
...
options:
  ...
  state:
    ...
    - On C(present), it will create a mediatype if it does not exist or update the
      mediatype if the associated data is different.
  ...
  smtp_authentication:
    type: bool
    description:
    - Whether SMTP authentication with username and password should be enabled or
      not.
