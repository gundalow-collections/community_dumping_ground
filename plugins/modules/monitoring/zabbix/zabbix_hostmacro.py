...
DOCUMENTATION = '''module: zabbix_hostmacro
...
options:
  ...
  macro_name:
    description:
    - Name of the host macro without the enclosing curly braces and the leading dollar
      sign.
    required: true
  macro_value:
    description:
  ...
  state:
    description:
    - State of the macro.
    - On C(present), it will create if macro does not exist or update the macro if
