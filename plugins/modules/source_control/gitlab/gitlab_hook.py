...
DOCUMENTATION = '''module: gitlab_hook
...
options:
  ...
  hook_url:
    description:
    - The url that you want GitLab to post to, this is used as the primary key for
      updates and deletion.
    required: true
    type: str
  state:
    description:
    - When C(present) the hook will be updated to match the input or created if it
      doesn't exist.
  ...
  token:
    ...
    - If this is present it will always result in a change as it cannot be retrieved
      from GitLab.
